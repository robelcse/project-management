    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate="" method="post" action={{ url('developers/'.$developer->developer_id) }}>
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label class="form-label" for="validationCustom01">First name</label>
                                <input class="form-control" id="validationCustom01" type="text" name="first_name" value={{ $developer->first_name }} required="" />
                                <div class="invalid-feedback">Please enter first name!</div>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="validationCustom02">Last name</label>
                                <input class="form-control" id="validationCustom02" type="text" name="last_name" value={{ $developer->last_name }} required="">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group"><span class="input-group-text" id="inputGroupPrepend">@</span>
                                    <input class="form-control" id="validationCustomUsername" type="email" name="email" value={{ $developer->email }} aria-describedby="inputGroupPrepend" required="">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="validationTextarea" name="skills" required="">{{ $developer->skills }}</textarea>
                                <div class="invalid-feedback">Please enter skills!</div>
                                <div class="valid-feedback">Looks good!</div>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="validationTextarea">Socail Profile</label>
                                <textarea class="form-control" id="validationTextarea" name="social_profile" required="">{{ $developer->social_profile }}</textarea>
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="validationTextarea" name="market_place_profile" required="">{{ $developer->market_place_profile }}</textarea>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="validationTextarea" name="communication_medium" required="">{{ $developer->communication_medium }}</textarea>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="validationCustom03" type="date" name="date_of_birth" value={{ $developer->date_of_birth }} required="">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="validationCustom04" name="gender" required="">
                                    ...
                                    <option value="Other" {{ $developer->gender == 'Other' ? 'selected':''}}>Others</option>
                                </select>
