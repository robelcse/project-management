    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="needs-validation" novalidate="" method="post" action={{ url('clients') }}>
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="validationCustom01" type="text" name="company" required="">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="validationCustom01" type="text" name="company_website" required="">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" id="validationCustom01" type="text" name="connect_by" required="">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="form-control" id="validationTextarea" name="communication_link" required=""></textarea>
