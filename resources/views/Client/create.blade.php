    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form novalidate="" method="post" action={{ url('clients') }}>
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input class="{{ $errors->has('company') ? 'form-control is-invalid':'form-control' }}" id="validationCustom01" type="text" name="company" required="">
                            ...
                            <div class="col-md-4">
                                ...
                                <input class="{{ $errors->has('company_website') ? 'form-control is-invalid':'form-control' }}" id="validationCustom01" type="text" name="company_website" required="">
                                @if($errors->has('company_website'))
                                <div class="invalid-feedback">{{ $errors->first('company_website') }}</div>
                                @endif
                            </div>

                            <div class="col-md-4">
                                <label class="form-label" for="validationCustom02">Logo</label>
                                <input class="{{ $errors->has('company_logo') ? 'form-control is-invalid':'form-control' }}" type="file" name="company_logo" aria-label="file example" required="">
                                @if($errors->has('company_logo'))
                                <div class="invalid-feedback">{{ $errors->first('company_logo') }}</div>
                                @endif
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input class="{{ $errors->has('connect_by') ? 'form-control is-invalid':'form-control' }}" id="validationCustom01" type="text" name="connect_by" required="">
                                @if($errors->has('connect_by'))
                                <div class="invalid-feedback">{{ $errors->first('connect_by') }}</div>
                                @endif
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <textarea class="{{ $errors->has('communication_link') ? 'form-control is-invalid':'form-control' }}" id="validationTextarea" name="communication_link" required=""></textarea>
                                @if($errors->has('communication_link'))
                                <div class="invalid-feedback">{{ $errors->first('communication_link') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="row g-3">
